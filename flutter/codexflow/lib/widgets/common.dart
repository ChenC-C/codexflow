...
class MarkdownBodyBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MarkdownBody(
      ...
      shrinkWrap: true,
      softLineBreak: true,
      syntaxHighlighter: _PlainCodeBlockHighlighter(),
      styleSheet: MarkdownStyleSheet(
        ...
        ).copyWith(backgroundColor: Palette.inlineCodeBackground),
...
class _PlainCodeBlockHighlighter extends SyntaxHighlighter {
  @override
  TextSpan format(String source) {
    return TextSpan(
      text: source.replaceAll(RegExp(r'\n$'), ''),
      style: roundedTextStyle(
        size: 11,
        weight: FontWeight.w500,
